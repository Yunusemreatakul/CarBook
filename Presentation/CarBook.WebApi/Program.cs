...
builder.Services.AddScoped<GetAboutQueryByIdHandler>();
...
builder.Services.AddScoped<GetContactByIdCommandHandler>();
builder.Services.AddScoped<GetContactCommandHandler>();
