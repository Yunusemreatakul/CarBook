...
{
    public class RemoveSocialMediaCommandHandle : IRequestHandler<RemoveSocialMediaCommand>
    {
        private readonly IRepository<SocialMedia> _socialMediaRepository;

        public RemoveSocialMediaCommandHandle(IRepository<SocialMedia> socialMediaRepository)
        {
